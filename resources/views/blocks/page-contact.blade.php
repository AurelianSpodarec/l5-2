<x-hero2 title="Contact" />

<x-section class="bg-gray-100">
<x-container>
            ...
            <div class="relative overflow-hidden py-10 px-6 bg-primary-700 sm:px-10 xl:p-12">
                ...
                <?php while ( have_rows( 'contact_info' ) ) : the_row(); ?>
                        ...
                        <?php if ( $title = get_sub_field( 'title' ) ) : ?>
                            ...
                            <h3 class="text-lg font-medium text-white"><?php echo esc_html( $title ); ?></h3>
                        <?php endif; ?>
                ...
                <dl class="mt-8 space-y-6">
                    ...
                    <dd class="flex text-base text-indigo-50">
                        ...
                        <?php if ( have_rows( 'contact_numbers', 'options' ) ) : ?>
                            <?php while ( have_rows( 'contact_numbers', 'options' ) ) : the_row(); ?>
                    
                                <?php if ( $phone_number = get_sub_field( 'phone_number', 'options' ) ) : ?>
                                    <span class="ml-3"><?php echo $phone_number; ?></span>
                                <?php endif; ?>
                    ...
                    <dd class="flex text-base text-indigo-50">
                        ...
                        <?php if ( $email = get_field( 'email', 'options' ) ) : ?>
                            <a class="ml-3" href="mailto:<?php echo $email; ?>"><?php echo $email; ?></a>
                        <?php endif; ?>
                    </dd>
                </dl>
    ...
    {!! do_shortcode('[contact-form-7 id="567" title="Main Contact Form"]') !!}
